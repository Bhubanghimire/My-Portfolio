...
SECRET_KEY = 'django-insecure-l7fmqcjb+82+1xs^o(6fv02o5tdud83n5v$(ps$ge%*5d)#-up'
...
CSRF_TRUSTED_ORIGINS = ['https://www.bhubanghimire.com.np']
...
NO_REPLY_EMAIL = config('OTP_EMAIL')
EMAIL_USE_TLS = True
EMAIL_PORT = 587
